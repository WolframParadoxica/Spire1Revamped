...
public class Concentrate() : Spire1RevampedCard(1, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        {
            var calculatedEnergy = original.EnergyCost.CostsX ? original.Owner.PlayerCombatState?.Energy ?? 0 : Math.Max(0, original.EnergyCost.GetWithModifiers(CostModifiers.All));
